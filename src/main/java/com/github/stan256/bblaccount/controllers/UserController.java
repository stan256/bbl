...
public class UserController {
    ...
    public ResponseEntity<CustomUserDetails> getUserProfile(@AuthenticationPrincipal CustomUserDetails currentUser) {
    ...
    @PreAuthorize("hasRole('ROLE_USER')")
    public ResponseEntity<Boolean> updateUserPassword(@AuthenticationPrincipal CustomUserDetails customUserDetails,
    ...
    @PostMapping("/logout")
    public ResponseEntity<Boolean> logoutUser(@AuthenticationPrincipal CustomUserDetails customUserDetails,
